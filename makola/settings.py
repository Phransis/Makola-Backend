"""
Django settings for makola project.
...
SECRET_KEY = 'django-insecure-oo3yz^u@*0jif1vnm3#0lm3_702&j4wvhas$&)kz7sz+g4#!$t'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1','https://makola-backend-8fes.onrender.com']
...
INSTALLED_APPS = [
    ...
    'shop_app',  # Custom app for shop functionality
